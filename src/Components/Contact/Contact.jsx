    ...
    <div className="contact">
      <div className="contact_col">
        ...
        <ul>
          ...
          <li><img src={phone_icon} alt="" />+1 123 56 789</li>
          <li><img src={location_icon} alt="" />77 HOSTEL CITY <br />ISLAMABAD, PAISTAN</li>
        </ul>
      ...
      <div className="contact_col">
        <form onSubmit={onSubmit}>
          ...
          <input type="tel" name='name' placeholder='Enter Your Name'  required/>
          <label>Phone Number</label>
          <input type="text" name='phone' placeholder='Enter Your Mobile No.'  required/>
          <label>Write Your Message Here</label>
          <textarea name="message"  rows='6' placeholder='Enter Your Message'  required/>
          <button className=' btn dark' type='submit'>Submit Now <img src={arrow} alt="" /></button>
        </form>
        <span>{result}</span>
      </div>
    </div>
